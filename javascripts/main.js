...
<script> 
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(37.422526,-85.191651),
            zoom: 6,
            zoomControl: true,
            zoomControlOptions: {
